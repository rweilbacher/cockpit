...
def extract_highlights(images: List[np.ndarray], output_folder: str) -> List[Dict]:
    highlighted_areas = []
        ...
        try:
            ...
            for color, (lower, upper) in COLOR_RANGES.items():
                ...
                for i, contour in enumerate(contours):
                    ...
                    highlight_image = img[y:y + h, x:x + w]
...
def process_pdf(pdf_path: str, output_folder: str) -> List[Dict]:
    try:
        ...
        highlighted_areas = extract_highlights(images, output_folder)
...
if __name__ == "__main__":
    ...
    PDF_PATH = "C:\\Users\\Roland\\Google Drive\\Projects\\cockpit\\pdf\\annotated.pdf"
    OUTPUT_FOLDER = "C:\\Users\\Roland\\Google Drive\\Projects\\cockpit\\pdf\\output"
    highlighted_areas = process_pdf(PDF_PATH, OUTPUT_FOLDER)
